...
export const FEATURES = [
  ...
  { name: '연관 키워드 추천', description: '검색량 상위 100개를 순위와 함께 보여줍니다.' },
  {
    name: '경쟁강도 분석',
  ...
  { name: '다중 상품 일괄 처리', description: 'CSV로 여러 상품의 커버리지·태그 후보를 한 번에 계산합니다.' },
  {
    name: '순위 조회',
    description: '키워드 검색 결과에서 내 블로그·카페 글의 위치를 최대 1000위까지 찾습니다.',
    guideSlug: 'blog-rank-check',
  },
  { name: '검색 추이', description: '최근 12개월 상대 검색 지수를 그래프로 보여줍니다.' },
  {
    name: '구매층·시즌성',
